...
export class TimeCommitmentParser {
     ...
     */
    async parseTimeCommitment(jobData) {
        try {
...
`;
     ...
     * @returns The determined time commitment: 'Evening', 'Weekend', 'Summer', or undefined
     */
    async parseTimeCommitmentFromText(title, description, requirements) {
        try {
...
// Singleton instance
let timeCommitmentParser = null;
/**
 * Get the Time Commitment Parser instance
 */
export function getTimeCommitmentParser() {
