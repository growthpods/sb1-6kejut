// Script to fetch internships from RapidAPI Internships API and store them in Supabase using Supabase client
...
// Function to check if an internship already exists in the database using Supabase client
...
// Function to insert internships into the database using Supabase client
async function insertInternships(internships) {
  console.log('Inserting internships into the database using Supabase client...');
...
async function main() {
  console.log('Starting RapidAPI Internships fetch script with Supabase client...');
  ...
  // Insert internships into the database using Supabase client
  await insertInternships(filteredInternships);
  
  console.log('RapidAPI Internships fetch script with Supabase client completed successfully.');
}
