...
const educationLevelParser_ts_1 = require("../src/lib/educationLevelParser.ts");
const timeCommitmentParser_ts_1 = require("../src/lib/timeCommitmentParser.ts");
const firecrawl_ts_1 = require("../src/lib/firecrawl.ts");
...
const educationLevelParser = (0, educationLevelParser_ts_1.getEducationLevelParser)();
const timeCommitmentParser = (0, timeCommitmentParser_ts_1.getTimeCommitmentParser)();
const firecrawl = (0, firecrawl_ts_1.getFirecrawlService)();
            ...
            try {
                ...
                for (let i = 0; i < jobs.length; i++) {
                    ...
                    try {
                        ...
                        const educationLevel = await educationLevelParser.parseEducationLevelFromText(job.title || '', job.description || '', job.requirements || []);
                        const timeCommitment = await timeCommitmentParser.parseTimeCommitmentFromText(job.title || '', job.description || '', job.requirements || []);
