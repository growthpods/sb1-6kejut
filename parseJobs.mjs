...
import * as educationLevelParserModule from './src/lib/educationLevelParser.js';
const { getEducationLevelParser } = educationLevelParserModule;
import * as timeCommitmentParserModule from './src/lib/timeCommitmentParser.js';
const { getTimeCommitmentParser } = timeCommitmentParserModule;
import * as firecrawlModule from './src/lib/firecrawl.js';
const { getFirecrawlService } = firecrawlModule;
